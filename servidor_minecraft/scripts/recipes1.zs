...
// Eliminar el crafteo original del Ground Trap
recipes.remove(<harvestcraft:groundtrap>);

// Añadir el nuevo crafteo aceptando cualquier trampilla de madera (ore:trapdoorWood)
recipes.addShaped("groundtrap_any_trapdoor", <harvestcraft:groundtrap>,
 [[<minecraft:stick>, <ore:trapdoorWood>, <minecraft:stick>],
  [<minecraft:string>, <minecraft:chest>, <minecraft:string>],
  [<minecraft:stick>, <minecraft:string>, <minecraft:stick>]]);
  
// // Crafteo manual para el Gene De-splicer
// recipes.addShaped("custom_gene_desplicer", <hermitsarsenal:gene_desplicer>,
 // [[null, <hermitsarsenal:fragmented_genome>, <hermitsarsenal:fragmented_genome>],
  // [<hermitsarsenal:incinerated_flesh>, <hermitsarsenal:vengence_core>, <hermitsarsenal:fragmented_genome>],
  // [<srparasites:hardened_bone_handle>, <hermitsarsenal:incinerated_flesh>, null]]);
  
// // Crafteo manual para la Outbreak Dagger
// recipes.addShaped("custom_outbreak_dagger", <hermitsarsenal:outbreak_dagger>,
 // [[null, <srparasites:ada_reeker_drop>, <hermitsarsenal:reprogrammed_gland>],
  // [<hermitsarsenal:reprogrammed_gland>, <hermitsarsenal:vengence_core>, <srparasites:ada_reeker_drop>],
  // [<srparasites:hardened_bone_handle>, <hermitsarsenal:reprogrammed_gland>, null]]);
  
// // Crafteo manual para el Ignis Knife
// recipes.addShaped("custom_ignis_knife", <hermitsarsenal:ignis_knife>,
 // [[null, null, <minecraft:blaze_rod>],
  // [null, <hermitsarsenal:incinerated_flesh>, <srparasites:infectious_blade_fragment>],
  // [<minecraft:stick>, <minecraft:blaze_powder>, null]]);
  
// // Crafteo manual para la Seizer Spear
// recipes.addShaped("custom_seizer_spear", <hermitsarsenal:seizer_spear>,
 // [[<srparasites:dispatcher_drop>, <hermitsarsenal:vengence_core>, <srparasites:infectious_blade_fragment>],
  // [<srparasites:dispatcher_drop>, <srparasites:hardened_bone_handle>, <hermitsarsenal:rekindled_dispatcher>],
  // [<srparasites:hardened_bone_handle>, <srparasites:dispatcher_drop>, <srparasites:dispatcher_drop>]]);
  
// // Crafteo manual para el Seismic Warhammer
// recipes.addShaped("custom_seismic_warhammer", <hermitsarsenal:seismic_warhammer>,
 // [[<hermitsarsenal:vengence_core>, <srparasites:vile_shell>, <srparasites:ada_longarms_drop>],
  // [<srparasites:hardened_bone_handle>, <hermitsarsenal:rewoven_flesh>, <srparasites:vile_shell>],
  // [<hermitsarsenal:rewoven_flesh>, <srparasites:hardened_bone_handle>, <hermitsarsenal:vengence_core>]]);
  
// // Crafteo manual para el Ignis Chakram
// recipes.addShaped("custom_ignis_chakram", <hermitsarsenal:ignis_chakram>,
 // [[<hermitsarsenal:vengence_core>, <hermitsarsenal:ignis_knife>, <hermitsarsenal:incinerated_flesh>],
  // [<hermitsarsenal:ignis_knife>, <srparasites:hardened_bone_handle>, <hermitsarsenal:ignis_knife>],
  // [<hermitsarsenal:incinerated_flesh>, <hermitsarsenal:ignis_knife>, <hermitsarsenal:vengence_core>]]);
  
// // Crafteo manual para el Cytokine Mutator
// recipes.addShaped("custom_cytokine_mutator", <hermitsarsenal:cytokine_mutator>,
 // [[<srparasites:infectious_blade_fragment>, <hermitsarsenal:fragmented_genome>, <hermitsarsenal:fragmented_genome>],
  // [<hermitsarsenal:wrathful_core>, <hermitsarsenal:gene_desplicer>, <hermitsarsenal:fragmented_genome>],
  // [<srparasites:hardened_bone_handle>, <hermitsarsenal:wrathful_core>, <srparasites:infectious_blade_fragment>]]);
  
// // Crafteo manual para el Longarm Appendage
// recipes.addShaped("custom_longarm_appendage", <hermitsarsenal:longarm_appendage>,
 // [[<srparasites:dried_tendons>, <srparasites:dried_tendons>, <srparasites:ada_longarms_drop>],
  // [null, <hermitsarsenal:fragmented_genome>, <srparasites:ada_longarms_drop>],
  // [null, null, <srparasites:ada_longarms_drop>]]);
  
// // Crafteo manual para el Extended Appendage
// recipes.addShaped("custom_extended_appendage", <hermitsarsenal:extended_appendage>,
 // [[<srparasites:dispatcher_drop>, <srparasites:beckon_drop>, <srparasites:dispatcher_drop>],
  // [<hermitsarsenal:wrathful_core>, <hermitsarsenal:longarm_appendage>, <hermitsarsenal:wrathful_core>],
  // [<srparasites:dispatcher_drop>, <srparasites:beckon_drop>, <srparasites:dispatcher_drop>]]);
  
// ==================================================
// RECETAS PERSONALIZADAS — PARASITES
// Living Lance y Living Maul
// ==================================================
...
// Elimina cualquier receta anterior para evitar duplicados.
recipes.remove(<srparasites:weapon_lance>);
...
recipes.addShaped(
    ...
    [
        [
            ...
            <swparasites:infectious_long_blade_fragment>
        ],
        [
            null,
            <srparasites:vile_shell>,
            <swparasites:hardened_bone_pole>
        ],
        [
            <swparasites:hardened_bone_pole>,
            null,
...
// ------------------------------
// LIVING MAUL — MANGO LARGO
// ------------------------------

// Elimina cualquier receta anterior para evitar duplicados.
recipes.remove(<srparasites:weapon_maul>);
...
recipes.remove(<srparasites:armor_helm>);

recipes.addShaped(
    "custom_living_helmet",
...
recipes.remove(<srparasites:armor_chest>);

recipes.addShaped(
    "custom_living_chestplate",
...
recipes.remove(<srparasites:armor_pants>);

recipes.addShaped(
    "custom_living_leggings",
...
recipes.remove(<srparasites:armor_boots>);
